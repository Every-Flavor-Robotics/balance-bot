...
void MT6701Sensor::init(int scl, int sda, int cs) {
...
void MT6701Sensor::add_encoder(int cs_pin){
  ...
  esp_err_t ret=spi_bus_add_device(HSPI_HOST, &tx_device_config, &spi_device_);
  ESP_ERROR_CHECK(ret);
